<?php
App::uses('CommunitiesProjectsController', 'Controller');

/**
 * CommunitiesProjectsController Test Case
 *
 */
class CommunitiesProjectsControllerTest extends ControllerTestCase {
