...
<h2><?php echo __('Projects User'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($projectsUser['User']['id'], array('controller' => 'users', 'action' => 'view', $projectsUser['User']['id'])); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($projectsUser['ProjectsUser']['user_role']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Projects User'), array('action' => 'delete', $projectsUser['ProjectsUser']['id']), array(), __('Are you sure you want to delete # %s?', $projectsUser['ProjectsUser']['id'])); ?> </li>
