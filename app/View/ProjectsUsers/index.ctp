<div class="projectsUsers index">
	...
	<tr>
		...
		<td><?php echo h($projectsUser['ProjectsUser']['user_role']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $projectsUser['ProjectsUser']['id']), array(), __('Are you sure you want to delete # %s?', $projectsUser['ProjectsUser']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
