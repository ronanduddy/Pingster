...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('List Projects Users'), array('controller' => 'projects_users', 'action' => 'index')); ?> </li>
		...
		<li><?php echo $this->Html->link(__('New Friend'), array('controller' => 'users', 'action' => 'add')); ?> </li>
	</ul>
</div>
